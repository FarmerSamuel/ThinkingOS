...
2. Normalize Interaction, Pattern, SystemBehavior, EmergenceCondition, AlternativeExplanation without adding unsupported facts.
...
5. Evaluate PatternEvidence, InteractionBasis, LevelDistinction, AlternativeTesting, PredictiveUse using the shared 0–4 rubric.
