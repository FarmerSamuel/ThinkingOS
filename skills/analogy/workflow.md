...
2. Normalize TargetStructure, SourceAnalogue, StructuralMapping, Difference, Limitation without adding unsupported facts.
...
5. Evaluate StructuralFit, Relevance, DifferenceAwareness, Evidence, TransferValidity using the shared 0–4 rubric.
