# Make Association Workflow

1. Validate required inputs and registered dependencies.
2. Normalize Concept, Association, PriorKnowledge, Relationship, NovelConnection without adding unsupported facts.
...
5. Evaluate Relevance, Strength, Novelty, Evidence, Usefulness using the shared 0–4 rubric.
