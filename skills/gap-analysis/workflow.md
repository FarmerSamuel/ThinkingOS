...
2. Normalize InitialState, TargetState, Gap, Constraint, TransitionNeed without adding unsupported facts.
...
5. Evaluate StateClarity, GapValidity, Prioritization, ConstraintFit, Actionability using the shared 0–4 rubric.
