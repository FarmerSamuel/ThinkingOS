# Learning Triangle Workflow

1. Validate required inputs and registered dependencies.
2. Normalize LearningGoal, Explanation, Practice, Feedback, UnderstandingGap without adding unsupported facts.
...
5. Evaluate GoalAlignment, Balance, PracticeQuality, FeedbackQuality, Adaptability using the shared 0–4 rubric.
