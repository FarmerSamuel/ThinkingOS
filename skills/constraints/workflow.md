...
2. Normalize ValidatedProblem, Constraint, Assumption, FeasibleSpace, TradeOff without adding unsupported facts.
...
5. Evaluate Completeness, Classification, Evidence, Feasibility, Consistency using the shared 0–4 rubric.
