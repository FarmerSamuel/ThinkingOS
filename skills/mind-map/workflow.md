...
2. Normalize CentralTopic, Concept, Hierarchy, CrossLink, ConceptGraph without adding unsupported facts.
...
5. Evaluate Coverage, Hierarchy, LinkValidity, Readability, GoalAlignment using the shared 0–4 rubric.
