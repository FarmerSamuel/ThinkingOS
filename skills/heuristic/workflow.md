...
2. Normalize DecisionContext, Heuristic, ApplicabilityCondition, FailureCondition, TradeOff without adding unsupported facts.
...
5. Evaluate Simplicity, BoundaryClarity, Reliability, CostOfError, Testability using the shared 0–4 rubric.
